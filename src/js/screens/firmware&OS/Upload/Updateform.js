...
import {updateSoftware,updateSoftwareURI} from '../../../actions/Firmware/UploadAndUpdate';
...
class Updateform extends Component {
  ...
  _onSubmit () {
   ...
   /*  let key = this.refs.file.files[0].name;
    ...
    if (noErrors){
      this.props.dispatch(updateSoftware(file));
    ...
    this.props.dispatch(updateSoftwareURI(postURL));
    this.props.onClose();
  }
  ...
  render () {
    ...
    return (
      <LayerForm title="Update Firmware" submitLabel="Flash" 
