...
import { killAuthenticate } from '../../actions/Administration/kill';
import store from '../../store';




class killAuthenticateForm extends Component {
       ...
       //console.log(this.state)
        if (window.confirm("Are you sure you want to kill the system"))
        {
            if( !(window.confirm("Do you want to go back and stop the kill process ? ")))
            {
               ...
               this.props.dispatch(killAuthenticate(this.state.UserName, this.state.Password))
...
export default connect()(killAuthenticateForm);